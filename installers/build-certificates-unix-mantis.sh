...
../Resources/app/mantis.app/Contents/MacOS/mantis keytool -keystore conf/mantis.jks -export -alias mantis -file /Applications/Daedalus.app/Contents/MacOS/tls/ca/ca.der -storepass nopassword
